<template>
  <a-modal v-model="show" title="修改申请" @cancel="onClose" :width="800">
        ...
        <a-col :span="12">
          <a-form-item label='申请类型' v-bind="formItemLayout">
            <a-select v-decorator="[
              ...
              <a-select-option value="2">申请</a-select-option>
            </a-select>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label='申请状态' v-bind="formItemLayout">
            <a-select v-decorator="[
              'rackUp',
              { rules: [{ required: true, message: '请输入申请状态!' }] }
              ]">
