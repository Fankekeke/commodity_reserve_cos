<template>
  <a-modal v-model="show" title="仓库详情" @cancel="onClose" :width="800">
    ...
    <div style="font-size: 13px;font-family: SimHei" v-if="pharmacyData !== null">
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">仓库信息</span></a-col>
        <a-col :span="8"><b>仓库名称：</b>
          {{ pharmacyData.name }}
        </a-col>
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">仓库图片</span></a-col>
        <a-col :span="24">
          <a-upload
            name="avatar"
      ...
      <br/>
      <a-row style="padding-left: 24px;padding-right: 24px;">
        <a-col style="margin-bottom: 5px"><span style="font-size: 15px;font-weight: 650;color: #000c17">仓库位置</span></a-col>
      </a-row>
      <div>
